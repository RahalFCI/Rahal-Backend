...
{
    internal class RegisterExplorerDtoValidator : AbstractValidator<RegisterExplorerDto>
    {
        public RegisterExplorerDtoValidator()
        {
            ...
            RuleFor(x => x.CountryCode)
                ...
                .Must(CountryValidator.IsValid).WithMessage("Country code must be a valid ISO 3166-1 country code");
        }
    }
}
