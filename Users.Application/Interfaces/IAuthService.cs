...
namespace Users.Application.Interfaces
{
    ...
    {
        Task<ApiResponse<string>> RegisterAsync(BaseRegisterDto userDto, string Password, IFormFile? profilePicture = null, CancellationToken cancellationToken = default);
